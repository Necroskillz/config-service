...
func NewUserService(queries *db.Queries, variationContextService *variation.ContextService, validationService *validation.Service, validator *validator.Validator) *UserService {
...
func (s *UserService) GetUsers(ctx context.Context, filter UsersFilter) (core.PaginatedResult[UserDto], error) {
	...
	return core.PaginatedResult[UserDto]{
		Items:      userItems,
		TotalCount: total,
	}, nil
}
