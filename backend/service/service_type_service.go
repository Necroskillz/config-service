...
func NewServiceTypeService(unitOfWorkRunner db.UnitOfWorkRunner, queries *db.Queries, validator *Validator, validationService *ValidationService, currentUserAccessor *auth.CurrentUserAccessor) *ServiceTypeService {
	return &ServiceTypeService{unitOfWorkRunner: unitOfWorkRunner, queries: queries, validator: validator, validationService: validationService, currentUserAccessor: currentUserAccessor}
}
...
func (s *ServiceTypeService) GetServiceTypes(ctx context.Context) ([]ServiceTypeItemDto, error) {
...
func (s *ServiceTypeService) GetServiceType(ctx context.Context, id uint) (ServiceTypeDto, error) {
	serviceType, err := s.queries.GetServiceType(ctx, id)
	if err != nil {
		return ServiceTypeDto{}, NewDbError(err, "ServiceType")
	}
...
func (s *ServiceTypeService) validateCreateServiceType(ctx context.Context, params CreateServiceTypeParams) error {
	user := s.currentUserAccessor.GetUser(ctx)
	if !user.IsGlobalAdmin {
		return NewServiceError(ErrorCodePermissionDenied, "You are not authorized to create service types")
	}
	...
	if taken {
		return NewServiceError(ErrorCodeInvalidOperation, "Service type name is already taken")
	}

	return nil
}

func (s *ServiceTypeService) CreateServiceType(ctx context.Context, params CreateServiceTypeParams) (uint, error) {
	...
	if err != nil {
		return 0, NewDbError(err, "ServiceType")
	}
...
func (s *ServiceTypeService) validateLinkVariationPropertyToServiceType(ctx context.Context, params LinkVariationPropertyToServiceTypeParams) error {
	user := s.currentUserAccessor.GetUser(ctx)
	if !user.IsGlobalAdmin {
		return NewServiceError(ErrorCodePermissionDenied, "You are not authorized to link variation properties to service types")
	}

	_, err := s.queries.GetServiceType(ctx, params.ServiceTypeID)
	if err != nil {
		return NewDbError(err, "ServiceType")
	}
	...
	if linked {
		return NewServiceError(ErrorCodeInvalidOperation, "Variation property is already linked to this service type")
	}

	return nil
}

func (s *ServiceTypeService) LinkVariationPropertyToServiceType(ctx context.Context, params LinkVariationPropertyToServiceTypeParams) error {
...
func (s *ServiceTypeService) validateUnlinkVariationPropertyToServiceType(ctx context.Context, params LinkVariationPropertyToServiceTypeParams) error {
	user := s.currentUserAccessor.GetUser(ctx)
	if !user.IsGlobalAdmin {
		return NewServiceError(ErrorCodePermissionDenied, "You are not authorized to unlink variation properties from service types")
	}
	...
	if idx == -1 {
		return NewServiceError(ErrorCodeInvalidOperation, "Variation property is not linked to this service type")
	}

	if links[idx].UsageCount > 0 {
		return NewServiceError(ErrorCodeInvalidOperation, "Variation property is already used in some services of this service type")
	}

	return nil
}

func (s *ServiceTypeService) UnlinkVariationPropertyToServiceType(ctx context.Context, params LinkVariationPropertyToServiceTypeParams) error {
...
func (s *ServiceTypeService) validateUpdateServiceTypeVariationPropertyPriority(ctx context.Context, params UpdateServiceTypeVariationPropertyPriorityParams) (uint, error) {
	user := s.currentUserAccessor.GetUser(ctx)
	if !user.IsGlobalAdmin {
		return 0, NewServiceError(ErrorCodeInvalidOperation, "You are not authorized to update variation property values")
	}
	...
	if _, err := s.queries.GetVariationProperty(ctx, params.VariationPropertyID); err != nil {
		return 0, NewDbError(err, "VariationProperty")
	}
	...
	if idx == -1 {
		return 0, NewServiceError(ErrorCodeInvalidOperation, "Variation property is not linked to this service type")
	}

	return links[idx].ID, nil
}

func (s *ServiceTypeService) UpdateServiceTypeVariationPropertyPriority(ctx context.Context, params UpdateServiceTypeVariationPropertyPriorityParams) error {
...
func (s *ServiceTypeService) validateDeleteServiceType(ctx context.Context, id uint) error {
	user := s.currentUserAccessor.GetUser(ctx)
	if !user.IsGlobalAdmin {
		return NewServiceError(ErrorCodePermissionDenied, "You are not authorized to delete service types")
	}
	...
	if serviceType.UsageCount > 0 {
		return NewServiceError(ErrorCodeInvalidOperation, "Service type is already used in some services")
	}

	return nil
}

func (s *ServiceTypeService) DeleteServiceType(ctx context.Context, id uint) error {
