...
type VariationContextService struct {
	queries          *db.Queries
	unitOfWorkRunner db.UnitOfWorkRunner
	cache            *ristretto.Cache[string, any]
}

func NewVariationContextService(queries *db.Queries, unitOfWorkRunner db.UnitOfWorkRunner, cache *ristretto.Cache[string, any]) *VariationContextService {
	return &VariationContextService{
		queries:          queries,
...
func (v *VariationContextService) GetVariationContextValues(ctx context.Context, variationContextID uint) (map[uint]string, error) {
...
func (v *VariationContextService) GetVariationContextID(ctx context.Context, variationContextValues []uint) (uint, error) {
